...
static const char *fonts[]               = { "Iosevka:size=11:style=Bold" };
static const char dmenufont[]            = "Iosevka:size=11:style=bold";
...
static const Key keys[] = {
	...
	TAGKEYS(                        XK_8,                                  7)
	TAGKEYS(                        XK_9,                                  8)
  {      MODKEY,		        XK_Print,	spawn,		SHCMD("flameshot full -p ~/Screenshots -c") },
  { 0,                                  XK_Print,       spawn,		SHCMD("flameshot gui") }, 
  { 0,   XF86XK_AudioRaiseVolume,	                spawn,		SHCMD("wpctl set-volume -l 1.0 @DEFAULT_AUDIO_SINK@ 0%- && wpctl set-volume -l 1.0 @DEFAULT_AUDIO_SINK@ 5%+; kill -44 $(pidof dwmblocks)") },
